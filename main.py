...
# Chat Input within a Form to Handle Submission and Clearing
with st.form("chat_form", clear_on_submit=True):
    ...
    if submitted and prompt:
        ...
        if is_file_query := any(keyword in prompt.lower() for keyword in ["analyze", "summary", "summarize", "tell me about", "information from", "details of"]) and st.session_state["uploaded_file_content"]:
        ...
        elif is_search_query := any(keyword in prompt.lower() for keyword in ["search for", "look up", "find", "google", "web search", "search the web"]):
        ...
        # Optionally, you can display the response immediately
        if response:
